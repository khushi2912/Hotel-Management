...
<body>
	...
	<aside id="fh5co-hero" class="js-fullheight">
		<div class="flexslider js-fullheight">
			<ul class="slides">
		   	<li style="background-image: url(images/bobmd-view-2379-hor-clsc.jpg);">
		   			...
		   			<div class="col-md-12 col-md-offset-0 text-center slider-text">
		   				<div class="slider-text-inner js-fullheight">
		   					<div class="desc">
			   					...
			   					<p>
			   						<a href="reservation1.php" class="btn btn-primary btn-lg">Book Now</a>
			   					</p>
		   					</div>
		   				</div>
		   			</div>
		   	...
		   	<li style="background-image: url(images/149332473.jpg);">
		   		<div class="overlay-gradient"></div>
		   		<div class="container">
		   			<div class="col-md-12 col-md-offset-0 text-center slider-text">
		   				<div class="slider-text-inner js-fullheight">
		   	...
		   	<li style="background-image: url(images/bobmd-garden-reception-1602-hor-clsc.jpg);">
		   		<div class="overlay-gradient"></div>
		   		<div class="container">
		   			<div class="col-md-12 col-md-offset-0 text-center slider-text">
		   				<div class="slider-text-inner js-fullheight">
	...
	<div id="featured-hotel" class="fh5co-bg-color">
		<div class="container">
			...
			<div class="feature-full-2col">
				<div class="f-hotel">
					<div class="image" style="background-image: url(images/IMG_2001.jpg);">
						<div class="descrip text-center">
				...
				<div class="f-hotel">
					<div class="image" style="background-image: url(images/2755_ro_01_p_1024x768.jpg);">
						<div class="descrip text-center">
							<p><small>For as low as</small><span>$99/night</span></p>
						</div>
					</div>
				...
				<div class="tab-content-container">
					<div class="tab-content active show" data-tab-content="tab1">
						<div class="container">
							<div class="row">
								<div class="col-md-6">
									<img src="images/iriatai.jpg" class="img-responsive" alt="Image">
								</div>
								<div class="col-md-6">
					...
					<div class="tab-content" data-tab-content="tab2">
						<div class="container">
							<div class="row">
								<div class="col-md-6">
									<img src="images/bora-bora-best-late-night-bars-in-bora-bora-hurricane-bar-at-sofitel.jpg" class="img-responsive" alt="Image">
								</div>
								<div class="col-md-6">
									<span class="super-heading-sm">World Class</span>
					...
					<div class="tab-content" data-tab-content="tab3">
						<div class="container">
							<div class="row">
								<div class="col-md-6">
									<img src="images/53.jpg" class="img-responsive" alt="Image">
								</div>
								<div class="col-md-6">
									<span class="super-heading-sm">World Class</span>
					...
					<div class="tab-content" data-tab-content="tab4">
						<div class="container">
							<div class="row">
								<div class="col-md-6">
									<img src="images/swimming-pool.jpg" class="img-responsive" alt="Image">
								</div>
								<div class="col-md-6">
									<span class="super-heading-sm">World Class</span>
					...
					<div class="tab-content" data-tab-content="tab5">
						<div class="container">
							<div class="row">
								<div class="col-md-6">
									<img src="images/spa-thumb.jpg" class="img-responsive" alt="Image">
								</div>
								<div class="col-md-6">
									<span class="super-heading-sm">World Class</span>
					...
					<div class="tab-content" data-tab-content="tab6">
						<div class="container">
							<div class="row">
								<div class="col-md-6">
									<br><br><br><br>
									<img src="https://www.sprouthealthlifestyle.com/wp-content/uploads/2019/02/7-Best-gyms.jpg" class="img-responsive" alt="Image">
								</div>
								<div class="col-md-6">
									<span class="super-heading-sm">World Class</span>
	...
	<div id="testimonial">
		<div class="container">
			...
			<br>
			<p>
				<a href="feedback.html" class="btn btn-primary btn-lg" style="background-color:white;color:black;">Give Feedback</a>
			</p>
		</div>
	</div>
	</div>
